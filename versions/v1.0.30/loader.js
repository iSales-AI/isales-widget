 ...
 * Generated: 2025-07-04T14:21:03.888Z
 * 
...
(function(window, document) {
  ...
  const CONFIG = {
    VERSION: '1.0.30',
    WIDGET_URL: 'https://cdn.jsdelivr.net/gh/iSales-AI/isales-widget@main/versions/v1.0.30/widget.js',
    CSS_URL: 'https://cdn.jsdelivr.net/gh/iSales-AI/isales-widget@main/versions/v1.0.30/widget.css',
    TIMEOUT: 15000,
    MAX_RETRIES: 3,
    RETRY_DELAY: 1000,
  };
  ...
  const CDN_FALLBACKS = {
    WIDGET: [
      CONFIG.WIDGET_URL,
      `https://cdn.statically.io/gh/iSales-AI/isales-widget/main/versions/v1.0.30/widget.js`,
      `https://raw.githack.com/iSales-AI/isales-widget/main/versions/v1.0.30/widget.js`
    ],
    CSS: [
      CONFIG.CSS_URL,
      `https://cdn.statically.io/gh/iSales-AI/isales-widget/main/versions/v1.0.30/widget.css`,
      `https://raw.githack.com/iSales-AI/isales-widget/main/versions/v1.0.30/widget.css`
    ],
    REACT: [
...
#isales-widget-root *, #isales-widget-root *::before, #isales-widget-root *::after {
  ...
  const api = {
    ...
    _buildTime: '2025-07-04T14:21:03.888Z',
  };
