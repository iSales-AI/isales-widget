 ...
 * Generated: 2025-07-06T07:06:19.822Z
 * 
...
(function(window, document) {
  ...
  const CONFIG = {
    VERSION: '1.0.31',
    BUILD_HASH: '1031',
    TIMESTAMP: 1751785579822,
    WIDGET_URL: 'https://cdn.jsdelivr.net/gh/iSales-AI/isales-widget@main/versions/v1.0.31/widget.js?v=1.0.31&t=1751785579822',
    CSS_URL: 'https://cdn.jsdelivr.net/gh/iSales-AI/isales-widget@main/versions/v1.0.31/widget.css?v=1.0.31&t=1751785579822',
    VERSION_CHECK_URL: 'https://cdn.jsdelivr.net/gh/iSales-AI/isales-widget@main/versions/v1.0.31/manifest.json',
    TIMEOUT: 15000,
    MAX_RETRIES: 3,
    RETRY_DELAY: 1000,
  ...
  const CDN_FALLBACKS = {
    WIDGET: [
      CONFIG.WIDGET_URL,
      `https://cdn.statically.io/gh/iSales-AI/isales-widget/main/versions/v1.0.31/widget.js?v=${CONFIG.VERSION}&t=${CONFIG.TIMESTAMP}`,
      `https://raw.githack.com/iSales-AI/isales-widget/main/versions/v1.0.31/widget.js?v=${CONFIG.VERSION}&t=${CONFIG.TIMESTAMP}`
    ],
    CSS: [
      CONFIG.CSS_URL,
      `https://cdn.statically.io/gh/iSales-AI/isales-widget/main/versions/v1.0.31/widget.css?v=${CONFIG.VERSION}&t=${CONFIG.TIMESTAMP}`,
      `https://raw.githack.com/iSales-AI/isales-widget/main/versions/v1.0.31/widget.css?v=${CONFIG.VERSION}&t=${CONFIG.TIMESTAMP}`
    ],
    REACT: [
...
#isales-widget-root *, #isales-widget-root *::before, #isales-widget-root *::after {
  ...
  const api = {
    ...
    _buildTime: '2025-07-06T07:06:19.822Z',
  };
