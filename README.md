...
#### JSDelivr
- **v1.0.24**: `https://cdn.jsdelivr.net/gh/iSales-AI/isales-widget@main/versions/v1.0.24/loader.js`
- **Minor v1.0**: `https://cdn.jsdelivr.net/gh/iSales-AI/isales-widget@main/versions/v1.0/loader.js`

#### Statically  
- **v1.0.24**: `https://cdn.statically.io/gh/iSales-AI/isales-widget/main/versions/v1.0.24/loader.js`
- **Minor v1.0**: `https://cdn.statically.io/gh/iSales-AI/isales-widget/main/versions/v1.0/loader.js`

#### GitHack
- **v1.0.24**: `https://raw.githack.com/iSales-AI/isales-widget/main/versions/v1.0.24/loader.js`
...
<script src="https://cdn.jsdelivr.net/gh/iSales-AI/isales-widget@main/versions/v1.0.24/loader.js"></script>
```
...
- **Latest Release**: v1.0.24 (2025-06-27)
